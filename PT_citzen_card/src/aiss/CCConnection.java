 ...
 * 
 * 
 * Request App: 1º Abre socket para se connectar ao servidor 2º Gera nounce e envia nouce
 * ao servidor 3º Servidor return 4º Cliente recebe o nounce e decifra-o usando a PK do
 * certificado e compara
 */
 ...
 * pessoa e armazenar a chave pública do respectivo Cartão de Cidadão, num ficheiro ou
 * numa base de dados. 2. O segundo componente deverá pedir ao primeiro componente um
 * pedido de autenticação e deverá receber um nounce. Este nounce deverá ser devolvido
 * cifrado com a chave privada existente no Cartão de Cidadão.
 */
