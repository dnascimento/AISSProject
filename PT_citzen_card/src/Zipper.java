...
public class Zipper {
    ...
    public void extrairZip(File diretorio) throws ZipException, IOException {
        extrairZip(getArquivoZipAtual(), diretorio);
    }

    public void extrairZip(File arquivoZip, File diretorio) throws ZipException,
            IOException {
        ZipFile zip = null;
        File arquivo = null;
        InputStream is = null;
    ...
    private List adicionarArquivoNoZip(
            ZipOutputStream zos,
                File arquivo,
        ...
        try {
            ...
            if (idx >= 0) {
                ...
                caminhoEntradaZip = arquivo.getAbsolutePath().substring(idx
                        + caminhoInicial.length() + 1);
            }
